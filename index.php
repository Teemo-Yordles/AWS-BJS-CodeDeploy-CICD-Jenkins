...
<body>
  ...
  <?php
    ...
    $public_id = @file_get_contents("http://instance-data/latest/meta-data/public-ipv4");
  ?>
    <img src="https://unisyscorp.sharepoint.com/teams/BrandCenter/PublishingImages/logo_guidelines/UnisysLockupCentered_R.png?ctag=190910" width="300"/>
    </br>    
    <h2>EC2 Instance ID: <?php echo $instance_id; ?></h2>
    <h2>EC2 Zone: <?php echo $zone; ?></h2>
    <h2>EC2 Public IP: <?php echo $public_id; ?></h2>
    </br>
